...
export default function DashboardStats({ totalIncome, totalExpenses }: DashboardStatsProps) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
      {/* Net Balance Card */}
      <div className="bg-card border border-border p-6 rounded-lg flex flex-col justify-between hover:border-emerald-500/30 transition-colors duration-300">
        <div>
          <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Net Balance</span>
          <h3 className={`text-2xl font-bold mt-2 ${isPositive ? 'text-emerald-400' : 'text-rose-400'}`}>
        ...
        <div className="mt-4 flex items-center">
          {isPositive ? (
            ...
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-medium bg-rose-500/10 text-rose-400 border border-rose-500/20">
      ...
      <div className="bg-card border border-border p-6 rounded-lg flex flex-col justify-between hover:border-emerald-500/30 transition-colors duration-300">
        ...
        <div className="mt-4">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-medium bg-surface text-slate-400 border border-border">
      ...
      {/* Total Expenses Card */}
      <div className="bg-card border border-border p-6 rounded-lg flex flex-col justify-between hover:border-rose-500/30 transition-colors duration-300">
        <div>
